  ...
  if (req.query && req.query.code) {
    ...
    function loaded(err, ok, state) {
      ...
      oauth2.getOAuthAccessToken(code, { grant_type: 'authorization_code', redirect_uri: callbackURL }, function(err, accessToken, refreshToken, params) {
        ...
        //optional 'iat' check removed
        var missing = ['iss', 'sub', 'aud', 'exp'].filter( function(param) { return !jwtClaims[param] } );
          ...
          function onProfileLoaded(profile) {
            ...
            if (self._passReqToCallback) {
              ...
              if (arity == 8) {
                ...
                self._verify(sub, profile, accessToken, refreshToken, verified);
              } else if (arity == 4) {
